...
import com.github.ldaniels528.scalascript.CancellablePromise
...
trait Interval extends js.Object {
   ...
   */
  def apply(fn: js.Function, delay: Int = 0, count: Int = 0, invokeApply: Boolean = true, pass: js.Any = js.native): CancellablePromise = js.native
